...
The markdown file "Figures_FitParameters.Rmd" generates the standalone Supplemental Figure 7 ("FigS7_Priors_Posteriors_byState_07.22.pdf"), which is a comparison of prior and posterior distributions by states, for the prediction run through July 22.  

### Reff(t) 

Figure 2 with Reff(t) and the transmission rebound is generated by the markdown file "Figures_ReffRebound.Rmd".

It also generates the ANOVA analysis of what are the greatest contributors to R(t) ("RtANOVAtable.xlsx") and the correlation plots in Supplemental Figure 8 ("FigS8_corr.2020.07.22.pdf").

### Testing, Tracing, Re-opening Scenarios

To run the testing, tracing, and re-opening scenarios, and generate Supplemental Figure S9, the function "run_plot_scenarios.R" should be sourced.  
