...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.506, 0.275, 0.00189, 0.831); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18.1, 2.25, 15.1, 21.8); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 5.32, 2.07, 2.68, 9.54); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 34.3, 9.32, 24.4, 54);
  Distrib(GM_rMax, TruncNormal, 0.667, 0.287, 0.215, 0.992);
  Distrib(GM_TauR, TruncNormal, 49.5, 11, 36.6, 61.7);
