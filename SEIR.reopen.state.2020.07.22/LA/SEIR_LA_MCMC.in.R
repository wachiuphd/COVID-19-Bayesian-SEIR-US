...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 30.1, 11, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.542, 0.136, 0, 2);
  Distrib(GM_TauR, TruncNormal, 43.3, 10.3, 14, 105);
