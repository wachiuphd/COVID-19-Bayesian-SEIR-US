...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 31.5, 6.15, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.444, 0.128, 0, 2);
  Distrib(GM_TauR, TruncNormal, 42.9, 8.96, 0, 105);
