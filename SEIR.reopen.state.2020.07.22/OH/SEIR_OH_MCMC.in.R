...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.468, 0.258, 0, 0.8); # Minimum value for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 33.4, 10.1, 26.3, 56.7);
  Distrib(GM_rMax, TruncNormal, 0.642, 0.207, 0.309, 0.901);
  Distrib(GM_TauR, TruncNormal, 48.5, 10.3, 33.5, 61.7);
