...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 30.8, 10.5, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.67, 0.224, 0, 2);
  Distrib(GM_TauR, TruncNormal, 34.9, 15.6, 0, 105);
  ...
  Level {
    ...
    Simulation { # OK 
      ...
      Data(D_pos, 1 0 0 1 0 1 2 2 1 7 1 1 6 7 4 4 4 4 5 16 12 1 8 6 2 3 9 15 8 5 3 1 3 21 6 9 9 6 1 2 10 7 8 8 8 0 0 9 6 7 6 4 2 2 4 0 6 1 3 0 0 6 5 5 3 4 0 2 5 4 4 3 5 0 0 5 2 3 0 1 3 0 5 2 2 2 0 0 0 4 1 2 1 1 1 0 2 1 3 2 7 1 0 2 2 6 3 0 0 1 5 3 3 6 5 1 2 4 4 6 7 6 0 1 9 13 -1 );
