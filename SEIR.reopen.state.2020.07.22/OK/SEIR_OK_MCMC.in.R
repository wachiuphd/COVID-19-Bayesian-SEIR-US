...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.517, 0.261, 0, 0.825); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18.9, 2.1, 15.7, 22); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.55, 1.44, 3.08, 7.22); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 30.8, 10.5, 18.5, 47.9);
  Distrib(GM_rMax, TruncNormal, 0.67, 0.224, 0.26, 0.965);
  Distrib(GM_TauR, TruncNormal, 34.9, 15.6, 2.66, 54.7);
  ...
  Level {
    ...
    Simulation { # OK 
      ...
      Data(D_pos, 1 0 0 1 0 1 2 2 1 7 1 1 6 7 4 4 4 4 5 16 12 1 8 6 2 3 9 15 8 5 3 1 3 21 6 9 9 6 1 2 10 7 8 8 8 0 0 9 6 7 6 4 2 2 4 0 6 1 3 0 0 6 5 5 3 4 0 2 5 4 4 3 5 0 0 5 2 3 0 1 3 0 5 2 2 2 0 0 0 4 1 2 1 1 1 0 2 1 3 2 7 1 0 2 2 6 3 0 0 1 5 3 3 6 5 1 2 4 4 6 7 6 0 1 0 22 );
