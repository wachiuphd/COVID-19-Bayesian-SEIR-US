...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 31.5, 8.37, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.648, 0.264, 0, 2);
  Distrib(GM_TauR, TruncNormal, 56.5, 17.2, 0, 105);
