...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.511, 0.273, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.1, 1.69, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.94, 1.71, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 31.5, 8.37, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.648, 0.264, 0, 2);
  Distrib(GM_TauR, TruncNormal, 56.5, 17.2, 14, 105);
