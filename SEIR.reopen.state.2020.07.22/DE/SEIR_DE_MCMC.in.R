...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 38.8, 8.53, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.618, 0.255, 0, 2);
  Distrib(GM_TauR, TruncNormal, 55.3, 10.4, 0, 105);
