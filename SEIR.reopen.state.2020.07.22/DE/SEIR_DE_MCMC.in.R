...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.438, 0.246, 0.00189, 0.795); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18.1, 1.42, 15.9, 19.5); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.45, 1.07, 3, 5.71); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 38.8, 8.53, 29, 54);
  Distrib(GM_rMax, TruncNormal, 0.618, 0.255, 0.242, 1.03);
  Distrib(GM_TauR, TruncNormal, 55.3, 10.4, 41.7, 71.9);
