...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.503, 0.259, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 19.6, 2.33, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 5.84, 2.56, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 29.8, 8.08, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.669, 0.235, 0, 2);
  Distrib(GM_TauR, TruncNormal, 40, 10, 14, 105);
