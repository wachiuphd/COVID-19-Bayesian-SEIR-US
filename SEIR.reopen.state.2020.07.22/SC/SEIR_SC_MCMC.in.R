...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 29.8, 8.08, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.669, 0.235, 0, 2);
  Distrib(GM_TauR, TruncNormal, 40, 10, 0, 105);
