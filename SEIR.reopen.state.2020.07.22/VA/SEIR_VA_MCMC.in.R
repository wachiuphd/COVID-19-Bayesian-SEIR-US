...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 36.7, 13.5, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.48, 0.208, 0, 2);
  Distrib(GM_TauR, TruncNormal, 56.7, 13.9, 0, 105);
