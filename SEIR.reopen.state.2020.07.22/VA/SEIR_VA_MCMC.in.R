...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.447, 0.241, 0.00305, 0.787); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18, 1.66, 15.4, 19.4); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.98, 0.99, 2.61, 5.41); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 36.7, 13.5, 28.4, 69.1);
  Distrib(GM_rMax, TruncNormal, 0.48, 0.208, 0.175, 0.797);
  Distrib(GM_TauR, TruncNormal, 56.7, 13.9, 34.5, 72.5);
