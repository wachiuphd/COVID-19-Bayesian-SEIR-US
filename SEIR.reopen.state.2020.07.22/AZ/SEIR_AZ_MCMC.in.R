...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 34.4, 7.97, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.342, 0.124, 0, 2);
  Distrib(GM_TauR, TruncNormal, 27.6, 7.2, 0, 105);
