...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 34.4, 7.97, 23.6, 50.6);
  Distrib(GM_rMax, TruncNormal, 0.342, 0.124, 0.156, 0.499);
  Distrib(GM_TauR, TruncNormal, 27.6, 7.2, 18.4, 38.8);
