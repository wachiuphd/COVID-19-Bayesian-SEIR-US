...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 38.2, 14.1, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.456, 0.182, 0, 2);
  Distrib(GM_TauR, TruncNormal, 58.5, 14, 0, 105);
  ...
  Level {
    ...
    Simulation { # MD 
      ...
      Data(D_pos, 0 1 0 1 0 1 0 2 3 7 7 11 8 9 12 20 17 21 16 22 31 30 34 43 37 49 37 48 30 42 41 44 57 49 47 52 68 49 53 44 54 69 58 50 47 49 52 52 44 60 63 49 47 49 46 47 54 56 49 50 32 42 34 23 53 32 35 38 38 41 43 37 24 34 29 21 20 2 34 38 9 27 35 33 31 25 26 13 8 35 14 20 14 22 14 8 18 16 21 13 15 11 7 15 15 7 11 13 7 3 20 9 13 15 7 9 6 9 7 6 12 9 9 5 20 3 -1 );
