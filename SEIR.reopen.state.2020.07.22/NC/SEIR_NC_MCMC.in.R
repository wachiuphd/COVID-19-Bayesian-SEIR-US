...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.473, 0.253, 0.000298, 0.82); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18.6, 2.15, 15.1, 21.1); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.24, 1.27, 3.11, 6.75); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 31.4, 11.8, 22.2, 59.4);
  Distrib(GM_rMax, TruncNormal, 0.514, 0.193, 0.226, 0.819);
  Distrib(GM_TauR, TruncNormal, 49.8, 9.67, 37.8, 64.9);
