...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 31.4, 11.8, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.514, 0.193, 0, 2);
  Distrib(GM_TauR, TruncNormal, 49.8, 9.67, 0, 105);
