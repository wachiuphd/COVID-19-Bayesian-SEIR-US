...
Level {
  ...
  Distrib(GM_PwrTheta, TruncNormal, 5.02, 1.23, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 36.2, 14, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.491, 0.183, 0, 2);
  Distrib(GM_TauR, TruncNormal, 60.9, 13.6, 14, 105);
