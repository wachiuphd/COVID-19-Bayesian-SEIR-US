...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 36.2, 14, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.491, 0.183, 0, 2);
  Distrib(GM_TauR, TruncNormal, 60.9, 13.6, 0, 105);
