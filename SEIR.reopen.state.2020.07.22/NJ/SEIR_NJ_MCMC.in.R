...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.342, 0.219, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.6, 1.74, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.29, 1.23, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 40.2, 20.7, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.528, 0.173, 0, 2);
  Distrib(GM_TauR, TruncNormal, 64.8, 28.3, 0, 105);
  ...
  Level {
    ...
    Simulation { # NJ 
      ...
      Data(D_pos, 4 2 5 4 7 17 18 19 27 32 21 37 69 88 182 109 200 71 86 229 272 196 232 251 167 93 362 351 362 322 230 132 175 376 310 305 249 246 75 106 398 328 458 310 204 129 39 334 305 252 151 164 139 55 198 194 244 192 111 107 79 151 161 96 142 96 52 11 47 148 62 130 103 64 23 49 110 90 79 57 70 38 89 74 66 46 100 36 51 51 42 31 35 22 13 25 54 46 1877 42 34 27 17 43 43 29 57 25 22 18 52 142 25 31 46 16 19 22 25 58 19 15 7 9 22 -1 );
