...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 40.2, 20.7, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.528, 0.173, 0, 2);
  Distrib(GM_TauR, TruncNormal, 64.8, 28.3, 14, 105);
