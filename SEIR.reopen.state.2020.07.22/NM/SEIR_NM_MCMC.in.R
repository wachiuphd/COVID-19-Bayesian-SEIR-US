...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 33, 15.9, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.482, 0.15, 0, 2);
  Distrib(GM_TauR, TruncNormal, 42.6, 20.2, 0, 105);
