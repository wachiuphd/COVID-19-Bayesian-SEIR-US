...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.469, 0.256, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 19.7, 2.26, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.47, 1.35, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 33, 15.9, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.482, 0.15, 0, 2);
  Distrib(GM_TauR, TruncNormal, 42.6, 20.2, 14, 105);
