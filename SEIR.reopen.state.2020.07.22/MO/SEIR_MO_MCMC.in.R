...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 30.5, 9.01, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.622, 0.228, 0, 2);
  Distrib(GM_TauR, TruncNormal, 48.4, 12.2, 0, 105);
