...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 29.5, 24.1, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.354, 0.105, 0, 2);
  Distrib(GM_TauR, TruncNormal, 53.2, 18.7, 0, 105);
