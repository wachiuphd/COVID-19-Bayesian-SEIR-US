...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.398, 0.236, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.6, 1.48, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.83, 1.03, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 31, 14.3, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.568, 0.207, 0, 2);
  Distrib(GM_TauR, TruncNormal, 54.6, 17.4, 14, 105);
  ...
  Level {
    ...
    Simulation { # CO 
      ...
      Data(D_pos, 0 1 1 1 1 1 4 8 5 7 13 7 0 18 11 17 14 15 14 10 29 14 57 0 24 30 4 21 28 17 17 20 11 27 37 22 44 122 8 26 54 6 11 43 12 10 9 52 18 40 7 14 6 22 53 29 0 0 43 47 33 61 26 0 0 0 26 21 33 13 0 0 4 43 26 1 19 0 0 18 20 16 11 9 0 0 25 0 29 15 12 0 0 9 17 2 18 7 0 0 26 12 0 1 0 0 0 21 0 2 37 5 0 0 3 5 7 14 0 0 0 0 28 -1 -1 -1 -1 );
