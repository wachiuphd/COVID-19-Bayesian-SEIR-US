...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.44, 0.249, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18.5, 1.96, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.98, 1.26, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 27.4, 8.82, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.429, 0.141, 0, 2);
  Distrib(GM_TauR, TruncNormal, 38.7, 11.5, 14, 105);
