...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 27.4, 8.82, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.429, 0.141, 0, 2);
  Distrib(GM_TauR, TruncNormal, 38.7, 11.5, 0, 105);
