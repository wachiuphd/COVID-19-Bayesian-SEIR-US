...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.42, 0.247, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.6, 1.66, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.87, 2.17, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 33.7, 16.3, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.546, 0.226, 0, 2);
  Distrib(GM_TauR, TruncNormal, 55.2, 19.7, 14, 105);
