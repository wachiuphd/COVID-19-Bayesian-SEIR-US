...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 28.5, 9.35, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.516, 0.205, 0, 2);
  Distrib(GM_TauR, TruncNormal, 47.7, 16.5, 14, 105);
