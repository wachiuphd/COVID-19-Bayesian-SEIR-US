...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 33.9, 18.3, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.669, 0.178, 0, 2);
  Distrib(GM_TauR, TruncNormal, 57.6, 18.2, 14, 105);
  ...
  Level {
    ...
    Simulation { # MI 
      ...
      Data(D_pos, 5 3 10 13 21 29 25 48 53 71 68 86 114 125 125 117 112 120 141 158 151 156 161 164 168 142 141 140 169 143 123 129 111 124 131 109 107 111 107 112 99 88 99 86 59 62 81 59 58 86 62 49 45 58 49 44 46 47 32 39 31 43 44 41 31 26 28 38 25 24 24 27 24 16 25 26 15 17 8 7 11 15 9 1 33 5 23 3 1 17 2 25 6 20 3 7 12 5 19 1 19 5 3 32 5 14 3 3 0 3 30 11 9 14 28 1 7 5 4 18 7 9 2 7 9 6 -1 -1 -1 -1 );
