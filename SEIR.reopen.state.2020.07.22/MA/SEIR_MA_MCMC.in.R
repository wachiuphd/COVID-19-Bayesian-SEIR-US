...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 40, 16.2, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.465, 0.19, 0, 2);
  Distrib(GM_TauR, TruncNormal, 60.3, 16.2, 0, 105);
