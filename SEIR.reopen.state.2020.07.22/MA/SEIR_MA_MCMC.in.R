...
Level {
  ...
  Distrib(GM_TauTheta, TruncNormal, 16.9, 1.55, 14.4, 18.4); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.94, 0.608, 3.14, 4.91); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 40, 16.2, 28.9, 78.9);
  Distrib(GM_rMax, TruncNormal, 0.465, 0.19, 0.229, 0.748);
  Distrib(GM_TauR, TruncNormal, 60.3, 16.2, 28.7, 78.4);
