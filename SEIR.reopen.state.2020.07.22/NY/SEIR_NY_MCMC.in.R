...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.331, 0.226, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.8, 1.88, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.96, 0.64, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 36.3, 17.1, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.43, 0.169, 0, 2);
  Distrib(GM_TauR, TruncNormal, 67.4, 10.1, 14, 105);
