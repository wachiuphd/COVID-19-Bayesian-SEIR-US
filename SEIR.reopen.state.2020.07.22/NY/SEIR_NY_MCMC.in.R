...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.331, 0.226, 0.000195, 0.735); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.8, 1.88, 14.5, 19.7); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.96, 0.64, 2.86, 4.71); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 36.3, 17.1, 25.8, 77.8);
  Distrib(GM_rMax, TruncNormal, 0.43, 0.169, 0.233, 0.656);
  Distrib(GM_TauR, TruncNormal, 67.4, 10.1, 44.6, 76);
