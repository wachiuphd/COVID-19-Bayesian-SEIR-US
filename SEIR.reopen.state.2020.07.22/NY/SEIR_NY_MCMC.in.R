...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 36.3, 17.1, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.43, 0.169, 0, 2);
  Distrib(GM_TauR, TruncNormal, 67.4, 10.1, 0, 105);
