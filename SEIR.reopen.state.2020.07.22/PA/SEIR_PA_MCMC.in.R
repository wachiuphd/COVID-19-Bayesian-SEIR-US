...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 37.1, 16.4, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.512, 0.19, 0, 2);
  Distrib(GM_TauR, TruncNormal, 56.3, 16.1, 14, 105);
