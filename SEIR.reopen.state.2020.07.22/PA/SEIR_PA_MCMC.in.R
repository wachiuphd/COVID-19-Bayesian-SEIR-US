...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.409, 0.242, 0, 0.782); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.3, 1.67, 14.8, 19); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.72, 1.26, 2.88, 6.65); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 37.1, 16.4, 27.5, 76.9);
  Distrib(GM_rMax, TruncNormal, 0.512, 0.19, 0.281, 0.797);
  Distrib(GM_TauR, TruncNormal, 56.3, 16.1, 23.3, 76.1);
