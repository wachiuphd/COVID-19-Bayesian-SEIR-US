...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.416, 0.241, 0.00175, 0.766); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18.1, 1.89, 15.2, 20.7); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.34, 0.979, 2.21, 5.21); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 25.6, 22.8, 4.62, 75.3);
  Distrib(GM_rMax, TruncNormal, 0.55, 0.214, 0.274, 0.877);
  Distrib(GM_TauR, TruncNormal, 63.8, 28.5, 21.9, 97);
