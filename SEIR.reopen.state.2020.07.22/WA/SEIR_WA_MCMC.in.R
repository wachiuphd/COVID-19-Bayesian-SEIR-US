...
Level {
  ...
  Distrib(GM_PwrTheta, TruncNormal, 3.34, 0.979, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 25.6, 22.8, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.55, 0.214, 0, 2);
  Distrib(GM_TauR, TruncNormal, 63.8, 28.5, 0, 105);
