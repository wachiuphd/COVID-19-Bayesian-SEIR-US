...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 25.6, 22.8, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.55, 0.214, 0, 2);
  Distrib(GM_TauR, TruncNormal, 63.8, 28.5, 14, 105);
