...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 35.4, 10.6, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.493, 0.145, 0, 2);
  Distrib(GM_TauR, TruncNormal, 55.5, 10.8, 0, 105);
