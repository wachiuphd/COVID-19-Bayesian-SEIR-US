...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.396, 0.251, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.7, 1.03, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 7.15, 1.52, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 35.4, 10.6, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.493, 0.145, 0, 2);
  Distrib(GM_TauR, TruncNormal, 55.5, 10.8, 14, 105);
