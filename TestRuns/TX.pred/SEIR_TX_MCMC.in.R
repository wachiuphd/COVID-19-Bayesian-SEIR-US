...
Level {
  ...
  Distrib(GM_TauTheta, TruncNormal, 18.5, 1.97, 14.9, 20); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.98, 1.26, 2.34, 5.91); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 27.2, 8.97, 17.7, 40.5);
  Distrib(GM_rMax, TruncNormal, 0.467, 0.14, 0.259, 0.689);
  Distrib(GM_TauR, TruncNormal, 43.4, 13.1, 23.1, 56.4);
