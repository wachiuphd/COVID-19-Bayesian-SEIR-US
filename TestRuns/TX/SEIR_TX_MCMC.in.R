...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 27.2, 8.97, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.467, 0.14, 0, 2);
  Distrib(GM_TauR, TruncNormal, 43.4, 13.1, 0, 105);
