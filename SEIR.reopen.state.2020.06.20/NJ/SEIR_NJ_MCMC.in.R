...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 39, 21.1, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.363, 0.0869, 0, 2);
  Distrib(GM_TauR, TruncNormal, 47.3, 19.1, 14, 105);
