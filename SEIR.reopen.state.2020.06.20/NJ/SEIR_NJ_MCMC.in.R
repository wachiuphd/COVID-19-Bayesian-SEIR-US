...
Level {
  ...
  Distrib(GM_TauTheta, TruncNormal, 17.6, 1.73, 15.1, 19.6); # Characteristic time for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 39, 21.1, 29, 90.9);
  Distrib(GM_rMax, TruncNormal, 0.363, 0.0869, 0.257, 0.529);
  Distrib(GM_TauR, TruncNormal, 47.3, 19.1, 0.964, 62.1);
