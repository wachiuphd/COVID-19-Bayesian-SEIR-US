...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.484, 0.257, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18.3, 2.77, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.85, 1.25, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 33.8, 12, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.557, 0.178, 0, 2);
  Distrib(GM_TauR, TruncNormal, 43.6, 13.2, 14, 105);
