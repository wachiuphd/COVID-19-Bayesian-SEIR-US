...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.469, 0.256, 0.000435, 0.807); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 19.7, 2.27, 16.3, 23.5); # Characteristic time for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 33, 15.9, 20.4, 70.6);
  Distrib(GM_rMax, TruncNormal, 0.462, 0.129, 0.233, 0.625);
  Distrib(GM_TauR, TruncNormal, 41, 18.3, 12.5, 61.8);
