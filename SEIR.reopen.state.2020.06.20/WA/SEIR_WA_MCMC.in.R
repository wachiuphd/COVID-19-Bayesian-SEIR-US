...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 26.4, 22.8, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.43, 0.123, 0, 2);
  Distrib(GM_TauR, TruncNormal, 49.1, 25.2, 0, 105);
