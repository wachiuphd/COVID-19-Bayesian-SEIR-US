...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.439, 0.258, 0, 0.818); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18.2, 1.64, 15.2, 20); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.97, 0.95, 2.8, 5.45); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 26, 22.9, 0, 63.1);
  Distrib(GM_rMax, TruncNormal, 0.458, 0.177, 0.22, 0.661);
  Distrib(GM_TauR, TruncNormal, 47.8, 28.1, 18.9, 101);
