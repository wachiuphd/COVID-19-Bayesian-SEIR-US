...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.388, 0.27, 0, 0.773); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.3, 1.15, 15, 18.5); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.84, 0.723, 2.69, 4.88); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 29.4, 23.8, 0, 65.7);
  Distrib(GM_rMax, TruncNormal, 0.325, 0.077, 0.223, 0.479);
  Distrib(GM_TauR, TruncNormal, 50.1, 20.1, 26, 81.1);
