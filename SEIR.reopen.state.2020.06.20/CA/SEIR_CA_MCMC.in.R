...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.388, 0.27, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.3, 1.15, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 3.84, 0.723, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 29.4, 23.8, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.325, 0.077, 0, 2);
  Distrib(GM_TauR, TruncNormal, 50.1, 20.1, 14, 105);
