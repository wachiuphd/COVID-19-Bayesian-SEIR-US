...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 29.4, 23.8, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.325, 0.077, 0, 2);
  Distrib(GM_TauR, TruncNormal, 50.1, 20.1, 0, 105);
