...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.506, 0.275, 0.0019, 0.831); # Minimum value for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 34.3, 9.32, 24.5, 54);
  Distrib(GM_rMax, TruncNormal, 0.615, 0.251, 0.226, 0.926);
  Distrib(GM_TauR, TruncNormal, 46.1, 9.24, 35.5, 57.8);
