...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 34.3, 9.32, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.615, 0.251, 0, 2);
  Distrib(GM_TauR, TruncNormal, 46.1, 9.24, 0, 105);
