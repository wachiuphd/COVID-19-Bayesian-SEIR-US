...
Level {
  ...
  Distrib(GM_PwrTheta, TruncNormal, 5.85, 1.89, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 30.3, 10.8, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.537, 0.131, 0, 2);
  Distrib(GM_TauR, TruncNormal, 42.4, 9.42, 0, 105);
