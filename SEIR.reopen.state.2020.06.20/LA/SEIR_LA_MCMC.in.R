...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.457, 0.252, 0, 0.816); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18.3, 1.59, 15.9, 20.2); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 5.85, 1.89, 4.38, 10); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 30.3, 10.8, 19.6, 52.9);
  Distrib(GM_rMax, TruncNormal, 0.537, 0.131, 0.345, 0.766);
  Distrib(GM_TauR, TruncNormal, 42.4, 9.42, 26.8, 55.7);
