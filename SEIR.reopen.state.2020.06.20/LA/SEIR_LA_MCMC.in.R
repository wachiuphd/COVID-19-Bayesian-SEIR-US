...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 30.3, 10.8, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.537, 0.131, 0, 2);
  Distrib(GM_TauR, TruncNormal, 42.4, 9.42, 14, 105);
