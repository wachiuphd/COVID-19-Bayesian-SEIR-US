...
Level {
  ...
  Distrib(GM_PwrTheta, TruncNormal, 4.72, 1.26, 2.87, 6.65); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 37.4, 16.8, 28, 78.5);
  Distrib(GM_rMax, TruncNormal, 0.433, 0.163, 0.272, 0.704);
  Distrib(GM_TauR, TruncNormal, 47.4, 14.6, 14, 59.7);
