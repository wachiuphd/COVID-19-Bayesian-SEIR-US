...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 37.4, 16.8, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.433, 0.163, 0, 2);
  Distrib(GM_TauR, TruncNormal, 47.4, 14.6, 0, 105);
