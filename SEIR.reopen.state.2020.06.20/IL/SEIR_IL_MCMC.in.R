...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.416, 0.245, 0, 0.779); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.4, 1.49, 15, 19.1); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 5.01, 1.23, 2.87, 6.46); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 36.2, 14.9, 25.2, 72);
  Distrib(GM_rMax, TruncNormal, 0.401, 0.151, 0.243, 0.626);
  Distrib(GM_TauR, TruncNormal, 50.1, 14.5, 17.9, 63.6);
