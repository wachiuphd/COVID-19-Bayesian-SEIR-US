...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.407, 0.233, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 17.9, 1.77, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.03, 0.797, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 38.6, 14, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.365, 0.143, 0, 2);
  Distrib(GM_TauR, TruncNormal, 46, 11.5, 14, 105);
