...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 38.6, 14, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.365, 0.143, 0, 2);
  Distrib(GM_TauR, TruncNormal, 46, 11.5, 0, 105);
