...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 31.6, 9.34, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.573, 0.184, 0, 2);
  Distrib(GM_TauR, TruncNormal, 42.2, 12, 0, 105);
