...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 33.9, 7.86, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.386, 0.127, 0, 2);
  Distrib(GM_TauR, TruncNormal, 32.7, 8.05, 0, 105);
