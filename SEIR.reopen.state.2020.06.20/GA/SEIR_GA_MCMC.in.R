...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.462, 0.25, 0, 1); # Minimum value for social distancing
  Distrib(GM_TauTheta, TruncNormal, 18.8, 2.19, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.47, 1.4, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 29.3, 8.8, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.473, 0.183, 0, 2);
  Distrib(GM_TauR, TruncNormal, 39.2, 11.9, 14, 105);
