...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 29.3, 8.8, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.473, 0.183, 0, 2);
  Distrib(GM_TauR, TruncNormal, 39.2, 11.9, 0, 105);
