...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 36.6, 18.7, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.309, 0.148, 0, 2);
  Distrib(GM_TauR, TruncNormal, 48.1, 16.2, 0, 105);
