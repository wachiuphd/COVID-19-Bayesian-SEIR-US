...
Level {
  ...
  Distrib(GM_PwrTheta, TruncNormal, 3.96, 0.649, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 36.6, 18.7, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.309, 0.148, 0, 2);
  Distrib(GM_TauR, TruncNormal, 48.1, 16.2, 14, 105);
