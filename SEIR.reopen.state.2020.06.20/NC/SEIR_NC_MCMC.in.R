...
Level {
  ...
  Distrib(GM_TauTheta, TruncNormal, 18.6, 2.17, 7, 35); # Characteristic time for social distancing
  Distrib(GM_PwrTheta, TruncNormal, 4.23, 1.28, 1, 11); # Power in Weibull model for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 32.7, 12.4, 21, 90);
  Distrib(GM_rMax, TruncNormal, 0.48, 0.159, 0, 2);
  Distrib(GM_TauR, TruncNormal, 43.9, 13.2, 14, 105);
