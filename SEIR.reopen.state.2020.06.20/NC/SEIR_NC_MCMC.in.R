...
Level {
  ...
  Distrib(GM_TauS, TruncNormal, 32.7, 12.4, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.48, 0.159, 0, 2);
  Distrib(GM_TauR, TruncNormal, 43.9, 13.2, 0, 105);
