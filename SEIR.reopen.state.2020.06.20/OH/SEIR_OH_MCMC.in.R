...
Level {
  ...
  Distrib(GM_ThetaMin, TruncNormal, 0.468, 0.257, 0, 1); # Minimum value for social distancing
  ...
  Distrib(GM_TauS, TruncNormal, 33.4, 10.1, 0, 90);
  Distrib(GM_rMax, TruncNormal, 0.625, 0.18, 0, 2);
  Distrib(GM_TauR, TruncNormal, 47.2, 8.83, 0, 105);
