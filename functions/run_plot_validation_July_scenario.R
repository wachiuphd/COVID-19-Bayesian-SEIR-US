...
pdf(file=file.path(figuredir,"FigS4_JulyValidationResults.pdf"),height=6,width=8)
...
dev.off()
write.csv(scennew.df,file.path(figuredir,"FigS4_JulyValidationCoverage.csv"))
