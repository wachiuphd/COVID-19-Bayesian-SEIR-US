...
scen.df <- data.frame(state=sort(rep(statesvec,12)),
                      ...
                      mu_Lambda = rep(rep(c(1,2,1,2),3),length(statesvec)),
                      DeltaDelta = rep(c(rep(0,4),rep(0.25,4),rep(-0.25,4)),length(statesvec)),
...
pdf(file=file.path(figuredir,"FigS10_Scenarios_Results_2020-07-22.pdf"),height=4,width=6)
