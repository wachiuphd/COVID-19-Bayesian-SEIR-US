...
```{r transmission rebound at 2020-06-20, echo=FALSE,fig.height=6,fig.width=6}
...
numDate <- as.numeric(as.Date("2020-06-20"))-as.numeric(as.Date(datezero))
t <- numDate
if (file.exists("scenparms_OneTime-2020-06-20.RData")) load("scenparms_OneTime-2020-06-20.RData") else {
...
if (file.exists("f_lambda_safemap-2020-06-20.RData")) load("f_lambda_safemap-2020-06-20.RData") else {
  gg.df <- data.frame()
  for (statenow in statesarr) {
...
save(scenparms,scenparms.med,file="scenparms_OneTime-2020-06-20.RData")
save(gg.df,file="f_lambda_safemap-2020-06-20.RData")
```
...
fig3current<-ggarrange(plotlist=p0list,
                ...
                legend="bottom",
                labels=c("A","B","C","D"))
ggsave("Fig3ABCDcurrent_06_20-08-15.pdf",plot=fig3current,height=4,width=6,scale=2.5)
ggsave("Fig3ABCDcurrent_06_20-08-15.jpeg",plot=fig3current,height=4,width=6,scale=2.5)
```
