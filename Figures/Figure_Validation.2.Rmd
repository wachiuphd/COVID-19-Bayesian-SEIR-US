...
Calibration using data until June 20. Validation with data through July 22.

```{r load second validation results, echo=FALSE, include=FALSE}
...
```{r second validation example states, echo=FALSE, fig.height=4.87,fig.width=8}
...
print(p)
ggsave("Fig1B.2.pdf",plot=p,height=4.5,width=13,scale=0.8)
# ggsave("Fig1B.2.png",plot=p,height=4.5,width=13,scale=1.1)
# ggsave("Fig1B.2.jpeg",plot=p,height=4.5,width=13,scale=1.1)
...
```{r second validation scatter plot, echo=FALSE, fig.height=6, fig.width=8.5}
...
figS3<-ggplot(predobs.df)+
  ...
  annotation_logticks()
print(figS3)
ggsave("FigS3.2.pdf",plot=figS3,height=6,width=8,scale=1.5)
ggsave("FigS3.2.jpeg",plot=figS3,height=6,width=8,scale=1.5)
```

Each panel shows data versus predictions for daily deaths (left column) or cases (right column), with calibration results shown in the top panels (through June 20) and validation results in the bottom panels (through July 22).  Each point includes the 95% CrI for the prediction. The band centered on the y=x line shows the additional 95% CrI for the negative binomial likelihood, which is used to account for day-to-day variation in reporting.
